...
export default function AllocationPage() {
    ...
    const runAllocation = async () => {
        ...
        try {
            ...
            setAllocations([
                { id: 101, village_name: "Katol", district: "Nagpur", priority_score: 92.3, wsi_score: 88.5, severity: "emergency", recommended_liters: 14700, assigned_tanker: { registration: "MH-31-TR-1021", capacity: 15000, driver: "Sachin Tayade", driver_phone: "8459468626" } },
                { id: 102, village_name: "Savner", district: "Nagpur", priority_score: 87.1, wsi_score: 82.1, severity: "critical", recommended_liters: 11050, assigned_tanker: { registration: "MH-31-TR-8890", capacity: 12000, driver: "Vijay Deshmukh", driver_phone: "8459468626" } },
                { id: 103, village_name: "Umred", district: "Nagpur", priority_score: 83.5, wsi_score: 78.9, severity: "critical", recommended_liters: 9620, assigned_tanker: { registration: "MH-31-TR-1234", capacity: 10000, driver: "Rohan Patil", driver_phone: "8459468626" } },
                { id: 104, village_name: "Kamptee", district: "Nagpur", priority_score: 79.2, wsi_score: 74.2, severity: "critical", recommended_liters: 18850, assigned_tanker: { registration: "MH-31-TR-5678", capacity: 20000, driver: "Rahul Gondane", driver_phone: "8459468626" } },
                { id: 105, village_name: "Hingna", district: "Nagpur", priority_score: 75.6, wsi_score: 69.8, severity: "warning", recommended_liters: 12300, assigned_tanker: { registration: "MH-31-TR-9012", capacity: 15000, driver: "Amol Wankhede", driver_phone: "8459468626" } },
            ]);
        }
        setLoading(false);
    };
