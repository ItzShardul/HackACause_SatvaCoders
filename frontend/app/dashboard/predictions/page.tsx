...
const demoPredictions = [
    ...
    { village_name: "Mauda", district: "Nagpur", current_wsi: 30.1, predicted_wsi: 42.7, current_severity: "normal", predicted_severity: "watch", predicted_demand_liters: 86400, predicted_tanker_trips: 8, confidence: 0.79, trends: { rainfall_direction: "declining", groundwater_direction: "declining" } },
    { village_name: "Narkhed", district: "Nagpur", current_wsi: 78.2, predicted_wsi: 88.4, current_severity: "critical", predicted_severity: "emergency", predicted_demand_liters: 215000, predicted_tanker_trips: 21, confidence: 0.86, trends: { rainfall_direction: "declining", groundwater_direction: "declining" } },
    { village_name: "Kamptee", district: "Nagpur", current_wsi: 45.2, predicted_wsi: 52.1, current_severity: "warning", predicted_severity: "warning", predicted_demand_liters: 84000, predicted_tanker_trips: 8, confidence: 0.82, trends: { rainfall_direction: "stable", groundwater_direction: "stable" } },
    { village_name: "Ramtek", district: "Nagpur", current_wsi: 68.4, predicted_wsi: 71.2, current_severity: "warning", predicted_severity: "critical", predicted_demand_liters: 224000, predicted_tanker_trips: 22, confidence: 0.84, trends: { rainfall_direction: "declining", groundwater_direction: "declining" } },
    { village_name: "Kalmeshwar", district: "Nagpur", current_wsi: 48.9, predicted_wsi: 55.3, current_severity: "warning", predicted_severity: "warning", predicted_demand_liters: 182000, predicted_tanker_trips: 18, confidence: 0.81, trends: { rainfall_direction: "declining", groundwater_direction: "stable" } },
    { village_name: "Nagpur Rural", district: "Nagpur", current_wsi: 30.1, predicted_wsi: 38.5, current_severity: "watch", predicted_severity: "watch", predicted_demand_liters: 650000, predicted_tanker_trips: 65, confidence: 0.88, trends: { rainfall_direction: "stable", groundwater_direction: "stable" } },
    { village_name: "Nagpur Urban", district: "Nagpur", current_wsi: 12.5, predicted_wsi: 15.2, current_severity: "normal", predicted_severity: "normal", predicted_demand_liters: 0, predicted_tanker_trips: 0, confidence: 0.92, trends: { rainfall_direction: "stable", groundwater_direction: "stable" } },
];
